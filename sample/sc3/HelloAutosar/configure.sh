...
# ビルドモジュール名
MODULE="SWC1.o SWC2.o Rte_Partition_EcucPartition_Rte.o Rte_Partition_EcucPartition_SWC1.o Rte_Partition_EcucPartition_SWC2.o"
...
then
	...
	CFG_OPT="-s"
	CMP_OPT="-o -DTOPPERS_PERFORMANCE -DMEASURE_100_NANO -DOTHER_PRC_SVC_TABLE=perf_add_syssrv.h -DUSE_KERNEL_LIBRARY_SYSLOG"
fi
