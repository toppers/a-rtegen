...
set APP_NAME=HelloAutosarWithCom_ECU1
...
call %RTE_DIR%/bin/bin/rtegen.bat %TARGET_DIR%/target_hw_counter.arxml ../../../../general/HelloAutosar/SystemDesk_WithCom_EcuInstance1.arxml ./%APP_NAME%.arxml
