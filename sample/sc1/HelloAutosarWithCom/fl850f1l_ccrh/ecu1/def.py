...
# Target board
TARGET = "fl850f1l_ccrh"

# Target mcu
TARGET_MCU = 'R7F701035xAFP'

# Application files
app_app_files = ['Rte.c',
                 ROOTDIR + '/a-rtegen/sample/general/HelloAutosar/SWC1.c',
                 ...
                 ROOTDIR + '/a-comstack/can/arch/rs_can/Can_Prc.c',
                 ROOTDIR + '/a-comstack/can/target/fl850f1l_ccrh/Can_Irq.c',
                 'Com_PBcfg.c',
                 'CanIf_PBcfg.c',
                 'CanIf_Lcfg.c',
                 'Can_PBcfg.c']
...
USER_INCLUDE = ['../a-rtegen/sample/general/HelloAutosar',
                ...
                '../a-comstack/can/target/fl850f1l_ccrh',
                '../a-comstack/stub',
                '../a-comstack/general']
