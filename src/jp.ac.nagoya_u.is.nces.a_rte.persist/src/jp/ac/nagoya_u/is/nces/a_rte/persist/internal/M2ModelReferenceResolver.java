...
public class M2ModelReferenceResolver {

	public void resolve(Autosar autosar) throws PersistException {
		try {
			TreeIterator<EObject> eAllContents = autosar.eAllContents();
			while (eAllContents.hasNext()) {
				ExtendedEObject eObject = (ExtendedEObject) eAllContents.next();
				eObject.resolveReferences();
			}
		} catch (ModelException e) {
			throw new PersistException("Error occurred while resolving autosar references. " + e.getMessage(), e);
		}
	}
}
