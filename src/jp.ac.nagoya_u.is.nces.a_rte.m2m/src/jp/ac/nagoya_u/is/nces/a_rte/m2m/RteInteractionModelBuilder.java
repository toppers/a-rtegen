...
public class RteInteractionModelBuilder {

	private final IInteractionModelBuildDirector buildDirector;

	public static RteInteractionModelBuilder forGeneratePhase() {
		return new RteInteractionModelBuilder(new InteractionModelBuildDirector());
	}

	private RteInteractionModelBuilder(IInteractionModelBuildDirector buildDirector) {
