...
public class SourceModelCacheBuilder {
	...
	public SourceModelCacheBuilder(InteractionModelBuildContext context) {
		this.context = context;
	}

	public void build() throws ModelException {
		this.context.cache.sourceUint8Type = this.context.query.findByID(Identifiers.RTE_INTERNAL_DATA_TYPE_REFERENCE_UINT8);
		this.context.cache.sourceUint16Type = this.context.query.findByID(Identifiers.RTE_INTERNAL_DATA_TYPE_REFERENCE_UINT16);
		this.context.cache.sourceUint32Type = this.context.query.findByID(Identifiers.RTE_INTERNAL_DATA_TYPE_REFERENCE_UINT32);
		this.context.cache.sourceComSignalIdType = this.context.query.findByID(Identifiers.RTE_INTERNAL_DATA_TYPE_REFERENCE_COM_SIGNAL_ID_TYPE);

		this.context.cache.sourceOs = this.context.query.findSingleByKind(OS);
