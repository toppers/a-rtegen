...
public class ModelSerializer {
	...
	public void serialize(XMIResource eResource, String file) throws ModelException {
		...
		URI oldAr4xPackageResourceURI = Ar4xPackage.eINSTANCE.eResource().getURI();
		Ar4xPackage.eINSTANCE.eResource().setURI(URI.createPlatformResourceURI("/jp.ac.nagoya_u.is.nces.a_rte.model/model/ar4x.ecore", true));

		eResource.setURI(URI.createFileURI(file));
		...
		try {
			...
			throw new ModelException("Internal error occurred while serializing model.", e);
		}

		RtePackage.eINSTANCE.eResource().setURI(oldRtePackageResourceURI);
		Ar4xPackage.eINSTANCE.eResource().setURI(oldAr4xPackageResourceURI);
	}
}
