 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.StructMemberImpl#getMemberName <em>Member Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.StructMemberImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StructMemberImpl extends ModuleObjectImpl implements StructMember {
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.STRUCT_MEMBER;
	}
	...
	public void setMemberName(String newMemberName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.STRUCT_MEMBER__MEMBER_NAME, oldMemberName, memberName));
	}
	...
	public Type getType() {
		if (type != null && ((EObject)type).eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.STRUCT_MEMBER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.STRUCT_MEMBER__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.STRUCT_MEMBER__MEMBER_NAME:
				return getMemberName();
			case ModulePackage.STRUCT_MEMBER__TYPE:
