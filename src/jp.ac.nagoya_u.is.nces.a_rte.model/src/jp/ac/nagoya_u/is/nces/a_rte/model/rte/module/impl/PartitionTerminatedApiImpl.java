 ...
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.PartitionTerminatedApiImpl#getActivationOperation <em>Activation Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PartitionTerminatedApiImpl extends RteLifecycleApiImpl implements PartitionTerminatedApi {
	...
	public EList<ActivationOperation> getActivationOperation() {
		if (activationOperation == null) {
			activationOperation = new EObjectContainmentEList<ActivationOperation>(ActivationOperation.class, this, ModulePackage.PARTITION_TERMINATED_API__ACTIVATION_OPERATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ModulePackage.PARTITION_TERMINATED_API__ACTIVATION_OPERATION:
