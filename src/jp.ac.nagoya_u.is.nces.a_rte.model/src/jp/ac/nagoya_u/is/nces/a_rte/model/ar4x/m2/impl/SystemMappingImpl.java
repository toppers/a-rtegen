...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>System Mapping</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.SystemMappingImpl#getDataMapping <em>Data Mapping</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SystemMappingImpl extends IdentifiableImpl implements SystemMapping {
	/**
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.SYSTEM_MAPPING;
	}
	...
	public EList<DataMapping> getDataMapping() {
		if (dataMapping == null) {
			dataMapping = new EObjectContainmentEList<DataMapping>(DataMapping.class, this, M2Package.SYSTEM_MAPPING__DATA_MAPPING);
		}
		return dataMapping;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case M2Package.SYSTEM_MAPPING__DATA_MAPPING:
