...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ecuc Abstract Reference Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.EcucAbstractReferenceValueImpl#getDefinitionRef <em>Definition Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class EcucAbstractReferenceValueImpl extends M2ObjectImpl implements EcucAbstractReferenceValue {
	/**
	 ...
	 * @generated
	 */
	protected EcucAbstractReferenceValueImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.ECUC_ABSTRACT_REFERENCE_VALUE;
	}
	...
	public void setDefinitionRef(String newDefinitionRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, M2Package.ECUC_ABSTRACT_REFERENCE_VALUE__DEFINITION_REF, oldDefinitionRef, definitionRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case M2Package.ECUC_ABSTRACT_REFERENCE_VALUE__DEFINITION_REF:
...
} //EcucAbstractReferenceValueImpl
