...
/**
 */
package jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.impl;

import jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.Ar4xFactory;
import jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.Ar4xPackage;
import jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.Ar4xRoot;
 ...
 * @generated
 */
public class Ar4xPackageImpl extends EPackageImpl implements Ar4xPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass ar4xRootEClass = null;
	 ...
	 * @see jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.Ar4xPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Ar4xPackageImpl() {
		super(eNS_URI, Ar4xFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Ar4xPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Ar4xPackage init() {
		if (isInited) return (Ar4xPackage)EPackage.Registry.INSTANCE.getEPackage(Ar4xPackage.eNS_URI);

		// Obtain or create and register package
		Ar4xPackageImpl theAr4xPackage = (Ar4xPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Ar4xPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Ar4xPackageImpl());
		...
		theAr4xPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Ar4xPackage.eNS_URI, theAr4xPackage);
		return theAr4xPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getAr4xRoot() {
		return ar4xRootEClass;
	}
	 ...
	 * @generated
	 */
	public Ar4xFactory getAr4xFactory() {
		return (Ar4xFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		ar4xRootEClass = createEClass(AR4X_ROOT);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theM2Package);
		getESubpackages().add(theEcucPackage);
