...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RPort In Composition Instance Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.RPortInCompositionInstanceRefImpl#getTargetRPort <em>Target RPort</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RPortInCompositionInstanceRefImpl extends PortInCompositionInstanceRefImpl implements RPortInCompositionInstanceRef {
	/**
	 ...
	 * @generated
	 */
	protected RPortInCompositionInstanceRefImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.RPORT_IN_COMPOSITION_INSTANCE_REF;
	}
		...
		if (targetRPort != null && ((EObject)targetRPort).eIsProxy()) {
			...
			if (targetRPort != oldTargetRPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, M2Package.RPORT_IN_COMPOSITION_INSTANCE_REF__TARGET_RPORT, oldTargetRPort, targetRPort));
			}
		}
		return targetRPort;
	}
	...
	public void setTargetRPort(RPortPrototype newTargetRPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, M2Package.RPORT_IN_COMPOSITION_INSTANCE_REF__TARGET_RPORT, oldTargetRPort, targetRPort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case M2Package.RPORT_IN_COMPOSITION_INSTANCE_REF__TARGET_RPORT:
	...
	/* (non-Javadoc)
	 * @see jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.PortInCompositionInstanceRefImpl#getInstanceRef()
	 */
	@Override
...
} //RPortInCompositionInstanceRefImpl
