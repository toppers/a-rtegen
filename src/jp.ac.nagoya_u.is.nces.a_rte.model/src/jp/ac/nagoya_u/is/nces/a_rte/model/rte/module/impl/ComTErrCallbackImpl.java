...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Com TErr Callback</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComTErrCallbackImpl#getTAckNotifyOperation <em>TAck Notify Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComTErrCallbackImpl extends ComCallbackImpl implements ComTErrCallback {
	/**
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.COM_TERR_CALLBACK;
	}
	...
	public EList<TAckNotifyOperation> getTAckNotifyOperation() {
		if (tAckNotifyOperation == null) {
			tAckNotifyOperation = new EObjectContainmentEList<TAckNotifyOperation>(TAckNotifyOperation.class, this, ModulePackage.COM_TERR_CALLBACK__TACK_NOTIFY_OPERATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModulePackage.COM_TERR_CALLBACK__TACK_NOTIFY_OPERATION:
