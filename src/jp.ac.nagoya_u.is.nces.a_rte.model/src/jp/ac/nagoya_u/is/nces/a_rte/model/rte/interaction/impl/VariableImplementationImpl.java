 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.interaction.impl.VariableImplementationImpl#getOwnerPartition <em>Owner Partition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class VariableImplementationImpl extends InteractionReferrableImpl implements VariableImplementation {
	/**
	...
	protected EClass eStaticClass() {
		return InteractionPackage.Literals.VARIABLE_IMPLEMENTATION;
	}
		...
		if (ownerPartition != null && ((EObject)ownerPartition).eIsProxy()) {
			...
			if (ownerPartition != oldOwnerPartition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.VARIABLE_IMPLEMENTATION__OWNER_PARTITION, oldOwnerPartition, ownerPartition));
			}
		}
	...
	public void setOwnerPartition(EcucPartition newOwnerPartition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.VARIABLE_IMPLEMENTATION__OWNER_PARTITION, oldOwnerPartition, ownerPartition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InteractionPackage.VARIABLE_IMPLEMENTATION__OWNER_PARTITION:
