...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Entity Starter Ex</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see jp.ac.nagoya_u.is.nces.a_rte.model.rte.ex.ExPackage#getEntityStarterEx()
 * @model
 * @extends ExtendedEObject
 * @generated
 */
public interface EntityStarterEx extends ExtendedEObject {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model ordered="false" this_Required="true"
	 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot body='this_.startInteraction.implementation\n\t\t\t\t\t->select(oclIsKindOf(interaction::TimingTriggeringEntityStartImplementation)).oclAsType(interaction::TimingTriggeringEntityStartImplementation)\n\t\t\t\t\t->asOrderedSet()'"
	 * @generated
	 */
	EList<TimingTriggeringEntityStartImplementation> getTimingTriggeringEntityStartImplementations(EntityStarter this_);
