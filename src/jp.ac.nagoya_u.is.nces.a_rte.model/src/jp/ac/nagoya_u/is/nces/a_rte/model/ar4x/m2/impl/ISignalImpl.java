 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.ISignalImpl#getSystemSignal <em>System Signal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ISignalImpl extends ArElementImpl implements ISignal {
	/**
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.ISIGNAL;
	}
		...
		if (systemSignal != null && ((EObject)systemSignal).eIsProxy()) {
			...
			if (systemSignal != oldSystemSignal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, M2Package.ISIGNAL__SYSTEM_SIGNAL, oldSystemSignal, systemSignal));
			}
		}
		return systemSignal;
	}
	...
	public void setSystemSignal(SystemSignal newSystemSignal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, M2Package.ISIGNAL__SYSTEM_SIGNAL, oldSystemSignal, systemSignal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case M2Package.ISIGNAL__SYSTEM_SIGNAL:
