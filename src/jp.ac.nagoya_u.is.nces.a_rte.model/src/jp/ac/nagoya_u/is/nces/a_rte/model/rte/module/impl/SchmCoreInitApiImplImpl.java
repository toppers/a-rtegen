...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Schm Core Init Api Impl</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SchmCoreInitApiImplImpl extends SchmInitApiImpl implements SchmCoreInitApiImpl {
	 ...
	 * @generated
	 */
	protected SchmCoreInitApiImplImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.SCHM_CORE_INIT_API_IMPL;
	}
	...
	public Core getParent() {
		if (eContainerFeatureID() != ModulePackage.SCHM_CORE_INIT_API_IMPL__PARENT) return null;
	...
	public NotificationChain basicSetParent(Core newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, ModulePackage.SCHM_CORE_INIT_API_IMPL__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(Core newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != ModulePackage.SCHM_CORE_INIT_API_IMPL__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.SCHM_CORE_INIT_API_IMPL__PARENT, newParent, newParent));
	}
