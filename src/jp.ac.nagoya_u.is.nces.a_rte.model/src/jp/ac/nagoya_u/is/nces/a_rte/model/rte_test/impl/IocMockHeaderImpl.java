...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ioc Mock Header</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte_test.impl.IocMockHeaderImpl#getIocApi <em>Ioc Api</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IocMockHeaderImpl extends HeaderFileImpl implements IocMockHeader {
	/**
	...
	protected EClass eStaticClass() {
		return RteTestPackage.Literals.IOC_MOCK_HEADER;
	}
	...
	public EList<IocApi> getIocApi() {
		if (iocApi == null) {
			iocApi = new EObjectResolvingEList<IocApi>(IocApi.class, this, RteTestPackage.IOC_MOCK_HEADER__IOC_API);
		}
		return iocApi;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RteTestPackage.IOC_MOCK_HEADER__IOC_API:
				return getIocApi();
		}
