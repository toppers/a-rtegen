...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rte Enter Api</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.RteEnterApiImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.RteEnterApiImpl#getIsNoneExclude <em>Is None Exclude</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RteEnterApiImpl extends RteApiImpl implements RteEnterApi {
	/**
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.RTE_ENTER_API;
	}
	...
	public NotificationChain basicSetOperation(ExcludeOperation newOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModulePackage.RTE_ENTER_API__OPERATION, oldOperation, newOperation);
	...
	public void setOperation(ExcludeOperation newOperation) {
		if (newOperation != operation) {
			...
			if (operation != null)
				msgs = ((InternalEObject)operation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModulePackage.RTE_ENTER_API__OPERATION, null, msgs);
			if (newOperation != null)
				msgs = ((InternalEObject)newOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModulePackage.RTE_ENTER_API__OPERATION, null, msgs);
			msgs = basicSetOperation(newOperation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.RTE_ENTER_API__OPERATION, newOperation, newOperation));
	}
	...
	public void setIsNoneExclude(Boolean newIsNoneExclude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.RTE_ENTER_API__IS_NONE_EXCLUDE, oldIsNoneExclude, isNoneExclude));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModulePackage.RTE_ENTER_API__OPERATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.RTE_ENTER_API__OPERATION:
				return getOperation();
			case ModulePackage.RTE_ENTER_API__IS_NONE_EXCLUDE:
