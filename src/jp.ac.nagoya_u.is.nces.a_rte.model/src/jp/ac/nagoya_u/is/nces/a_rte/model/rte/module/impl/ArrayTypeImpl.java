 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ArrayTypeImpl#getArraySize <em>Array Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayTypeImpl extends TypeImpl implements ArrayType {
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.ARRAY_TYPE;
	}
	...
	public void setArraySize(Integer newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.ARRAY_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.ARRAY_TYPE__ARRAY_SIZE:
				return getArraySize();
		}
