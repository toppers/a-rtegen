...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PPort In Composition Instance Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.PPortInCompositionInstanceRefImpl#getTargetPPort <em>Target PPort</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PPortInCompositionInstanceRefImpl extends PortInCompositionInstanceRefImpl implements PPortInCompositionInstanceRef {
	/**
	 ...
	 * @generated
	 */
	protected PPortInCompositionInstanceRefImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.PPORT_IN_COMPOSITION_INSTANCE_REF;
	}
		...
		if (targetPPort != null && ((EObject)targetPPort).eIsProxy()) {
			...
			if (targetPPort != oldTargetPPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, M2Package.PPORT_IN_COMPOSITION_INSTANCE_REF__TARGET_PPORT, oldTargetPPort, targetPPort));
			}
		}
		return targetPPort;
	}
	...
	public void setTargetPPort(PPortPrototype newTargetPPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, M2Package.PPORT_IN_COMPOSITION_INSTANCE_REF__TARGET_PPORT, oldTargetPPort, targetPPort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case M2Package.PPORT_IN_COMPOSITION_INSTANCE_REF__TARGET_PPORT:
...
} //PPortInCompositionInstanceRefImpl
