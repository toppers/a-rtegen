...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Com TAck Callback</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComTAckCallbackImpl#getTAckNotifyOperation <em>TAck Notify Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComTAckCallbackImpl extends ComCallbackImpl implements ComTAckCallback {
	/**
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.COM_TACK_CALLBACK;
	}
	...
	public EList<TAckNotifyOperation> getTAckNotifyOperation() {
		if (tAckNotifyOperation == null) {
			tAckNotifyOperation = new EObjectContainmentEList<TAckNotifyOperation>(TAckNotifyOperation.class, this, ModulePackage.COM_TACK_CALLBACK__TACK_NOTIFY_OPERATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModulePackage.COM_TACK_CALLBACK__TACK_NOTIFY_OPERATION:
