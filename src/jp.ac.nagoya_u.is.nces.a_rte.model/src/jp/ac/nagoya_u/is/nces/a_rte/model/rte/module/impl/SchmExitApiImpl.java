...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Schm Exit Api</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class SchmExitApiImpl extends SchmApiImpl implements SchmExitApi {
	/**
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.SCHM_EXIT_API;
	}
	...
	public NotificationChain basicSetOperation(ExcludeOperation newOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModulePackage.SCHM_EXIT_API__OPERATION, oldOperation, newOperation);
	...
	public void setOperation(ExcludeOperation newOperation) {
		if (newOperation != operation) {
			...
			if (operation != null)
				msgs = ((InternalEObject)operation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModulePackage.SCHM_EXIT_API__OPERATION, null, msgs);
			if (newOperation != null)
				msgs = ((InternalEObject)newOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModulePackage.SCHM_EXIT_API__OPERATION, null, msgs);
			msgs = basicSetOperation(newOperation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.SCHM_EXIT_API__OPERATION, newOperation, newOperation));
	}
