...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Com Receive Timeout Callback</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ComReceiveTimeoutCallback#getOperation <em>Operation</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ComReceiveTimeoutCallback#getDataVariable <em>Data Variable</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ComReceiveTimeoutCallback#getAccessApi <em>Access Api</em>}</li>
 * </ul>
 * </p>
 *
 * @see jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ModulePackage#getComReceiveTimeoutCallback()
 * @model
 * @generated
 */
public interface ComReceiveTimeoutCallback extends ComCallback {
	/**
	 ...
	 * @see jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ModulePackage#getComReceiveTimeoutCallback_Operation()
	 ...
	 * @see jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ModulePackage#getComReceiveTimeoutCallback_AccessApi()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ComReceiveTimeoutCallback#getAccessApi <em>Access Api</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
