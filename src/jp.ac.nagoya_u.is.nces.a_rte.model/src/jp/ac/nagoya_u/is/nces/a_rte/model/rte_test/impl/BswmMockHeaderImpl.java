...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bswm Mock Header</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte_test.impl.BswmMockHeaderImpl#getExecutableEntity <em>Executable Entity</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte_test.impl.BswmMockHeaderImpl#getBswmName <em>Bswm Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BswmMockHeaderImpl extends HeaderFileImpl implements BswmMockHeader {
	/**
	...
	protected EClass eStaticClass() {
		return RteTestPackage.Literals.BSWM_MOCK_HEADER;
	}
	...
	public EList<ExecutableEntity> getExecutableEntity() {
		if (executableEntity == null) {
			executableEntity = new EObjectResolvingEList<ExecutableEntity>(ExecutableEntity.class, this, RteTestPackage.BSWM_MOCK_HEADER__EXECUTABLE_ENTITY);
		}
	...
	public void setBswmName(String newBswmName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RteTestPackage.BSWM_MOCK_HEADER__BSWM_NAME, oldBswmName, bswmName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RteTestPackage.BSWM_MOCK_HEADER__EXECUTABLE_ENTITY:
				return getExecutableEntity();
			case RteTestPackage.BSWM_MOCK_HEADER__BSWM_NAME:
				return getBswmName();
		}
