...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Receiver Com Spec</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.ReceiverComSpecImpl#getDataElement <em>Data Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ReceiverComSpecImpl extends RPortComSpecImpl implements ReceiverComSpec {
	/**
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.RECEIVER_COM_SPEC;
	}
		...
		if (dataElement != null && ((EObject)dataElement).eIsProxy()) {
			...
			if (dataElement != oldDataElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, M2Package.RECEIVER_COM_SPEC__DATA_ELEMENT, oldDataElement, dataElement));
			}
		}
		return dataElement;
	}
	...
	public void setDataElement(VariableDataPrototype newDataElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, M2Package.RECEIVER_COM_SPEC__DATA_ELEMENT, oldDataElement, dataElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case M2Package.RECEIVER_COM_SPEC__DATA_ELEMENT:
