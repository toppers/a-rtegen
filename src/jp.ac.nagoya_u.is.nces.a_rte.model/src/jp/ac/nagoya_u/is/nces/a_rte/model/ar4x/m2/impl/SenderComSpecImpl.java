...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sender Com Spec</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public abstract class SenderComSpecImpl extends PPortComSpecImpl implements SenderComSpec {
	/**
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.SENDER_COM_SPEC;
	}
		...
		if (dataElement != null && ((EObject)dataElement).eIsProxy()) {
			...
			if (dataElement != oldDataElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, M2Package.SENDER_COM_SPEC__DATA_ELEMENT, oldDataElement, dataElement));
			}
		}
		return dataElement;
	}
	...
	public void setDataElement(VariableDataPrototype newDataElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, M2Package.SENDER_COM_SPEC__DATA_ELEMENT, oldDataElement, dataElement));
	}
