 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.BswSchedulableEntityImpl#getEvent <em>Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BswSchedulableEntityImpl extends BswModuleEntityImpl implements BswSchedulableEntity {
	/**
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.BSW_SCHEDULABLE_ENTITY;
	}
	...
	public EList<BswEvent> getEvent() {
		if (event == null) {
			event = new EObjectWithInverseResolvingEList<BswEvent>(BswEvent.class, this, M2Package.BSW_SCHEDULABLE_ENTITY__EVENT, M2Package.BSW_EVENT__STARTS_ON_EVENT);
		}
		return event;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case M2Package.BSW_SCHEDULABLE_ENTITY__EVENT:
