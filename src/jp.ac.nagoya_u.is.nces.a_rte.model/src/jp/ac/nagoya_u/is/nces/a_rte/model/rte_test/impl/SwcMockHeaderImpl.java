...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Swc Mock Header</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte_test.impl.SwcMockHeaderImpl#getSwcName <em>Swc Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte_test.impl.SwcMockHeaderImpl#getExecutableEntity <em>Executable Entity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SwcMockHeaderImpl extends HeaderFileImpl implements SwcMockHeader {
	/**
	...
	protected EClass eStaticClass() {
		return RteTestPackage.Literals.SWC_MOCK_HEADER;
	}
	...
	public void setSwcName(String newSwcName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RteTestPackage.SWC_MOCK_HEADER__SWC_NAME, oldSwcName, swcName));
	}
	...
	public EList<ExecutableEntity> getExecutableEntity() {
		if (executableEntity == null) {
			executableEntity = new EObjectResolvingEList<ExecutableEntity>(ExecutableEntity.class, this, RteTestPackage.SWC_MOCK_HEADER__EXECUTABLE_ENTITY);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RteTestPackage.SWC_MOCK_HEADER__SWC_NAME:
				return getSwcName();
			case RteTestPackage.SWC_MOCK_HEADER__EXECUTABLE_ENTITY:
