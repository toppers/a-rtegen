 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.RteBufferWriteTrustedFunctionImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.RteBufferWriteTrustedFunctionImpl#getDataVariable <em>Data Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RteBufferWriteTrustedFunctionImpl extends TrustedFunctionImpl implements RteBufferWriteTrustedFunction {
	/**
	 ...
	 * @generated
	 */
	protected RteBufferWriteTrustedFunctionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.RTE_BUFFER_WRITE_TRUSTED_FUNCTION;
	}
	...
	public void setOperation(RteBufferNonqueuedSendOperation newOperation) {
		if (newOperation != operation) {
			...
			if (operation != null)
				msgs = ((InternalEObject)operation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModulePackage.RTE_BUFFER_WRITE_TRUSTED_FUNCTION__OPERATION, null, msgs);
			if (newOperation != null)
				msgs = ((InternalEObject)newOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModulePackage.RTE_BUFFER_WRITE_TRUSTED_FUNCTION__OPERATION, null, msgs);
			msgs = basicSetOperation(newOperation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.RTE_BUFFER_WRITE_TRUSTED_FUNCTION__OPERATION, newOperation, newOperation));
	}
	...
	public LocalVariable getDataVariable() {
		if (dataVariable != null && ((EObject)dataVariable).eIsProxy()) {
			...
			if (dataVariable != oldDataVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.RTE_BUFFER_WRITE_TRUSTED_FUNCTION__DATA_VARIABLE, oldDataVariable, dataVariable));
			}
		}
		return dataVariable;
	}
	...
	public void setDataVariable(LocalVariable newDataVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.RTE_BUFFER_WRITE_TRUSTED_FUNCTION__DATA_VARIABLE, oldDataVariable, dataVariable));
	}
