...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Queued Receiver Com Spec</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.impl.QueuedReceiverComSpecImpl#getQueueLength <em>Queue Length</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class QueuedReceiverComSpecImpl extends ReceiverComSpecImpl implements QueuedReceiverComSpec {
	/**
	 ...
	 * @generated
	 */
	protected QueuedReceiverComSpecImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return M2Package.Literals.QUEUED_RECEIVER_COM_SPEC;
	}
	...
	public void setQueueLength(Integer newQueueLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, M2Package.QUEUED_RECEIVER_COM_SPEC__QUEUE_LENGTH, oldQueueLength, queueLength));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case M2Package.QUEUED_RECEIVER_COM_SPEC__QUEUE_LENGTH:
